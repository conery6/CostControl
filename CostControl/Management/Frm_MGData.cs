...
namespace CostControl.Management
{
    public partial class Frm_MGData : Form
    {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            dgv_MGData.Columns[1].ReadOnly = true;
            dgv_MGData.Columns[1].DefaultCellStyle.BackColor = Color.LightYellow;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (getPK())
            {
                ...
                object[] cells = { comB_Facility.Text, comB_CC.Text, int.Parse(comB_Year.Text), comB_RpType.Text };
        ...
        private void btn_Search_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                r = GetMGData.MiddleBudget(FNo, CCNo, Year, ReportMonth);
